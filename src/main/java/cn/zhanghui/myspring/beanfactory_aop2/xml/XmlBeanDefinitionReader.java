package cn.zhanghui.myspring.beanfactory_aop2.xml;
...
import cn.zhanghui.myspring.beanfactory_aop2.config.ConfigBeanDefinitionParser;
...
import cn.zhanghui.myspring.beanfactory_aop2.context.annotation.ClassPathBeanDefinitionScanner;
...
public class XmlBeanDefinitionReader {
	...
	public void loadBeanDefinition(Resource resource) {
		...
		try {
			...
			while (itr.hasNext()) {
				...
				}else if(isAOPNamespece(namespaceUri)) {
					parseAopElement(ele);
				}
			}
	 ...
	 * 判断命名方式是不是aop
	 */
	private boolean isAOPNamespece(String namespaceUri) {
